    ...
    <main>
                    ...
                    <div
                        ...
                        <div class="lg:py-24">
                            <h1
                                ...
                                <span
                                    class="block bg-gradient-to-r from-yellow-500 to-yellow-200 bg-clip-text pb-3 text-transparent sm:pb-5">keeps
                                    bugs away</span>
                            </h1>
        ...
        <div class="relative bg-gray-50 py-16 sm:py-24 lg:py-32">
            <div class="relative">
                ...
                <div class="relative mt-6 mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
                    <h2>
                    ...
                    <h2><livewire:create-category-button :coursesAll="$courses" /></h2>
                </div>
                <div
